...
public class ModBlocks {
	...
	public static final RegistryObject<Block> MANA_LIQUIDIZER = BLOCKS.register("mana_liquidizer", () -> new ManaLiquidizerBlock(BlockBehaviour.Properties.of(Material.STONE,
			MaterialColor.TERRACOTTA_WHITE).requiresCorrectToolForDrops().strength(2.0F, 6.0F).sound(SoundType.STONE)));
